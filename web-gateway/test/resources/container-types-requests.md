...
curl --request POST \
  --url http://localhost:9000/types/container \
	...
	"attributeDefinitions": [
		{
			...
			"metaType": "String",
			"name": "ct-ad-2",
			"displayName": "cont-type-attrib-def-1",
			"isCollection": false,
			"isModifiable": false,
			"isMandatory": true,
			"defaultValue": {
...
**Get a container type by key**

curl --request GET \
  --url http://localhost:9000/types/container/CONT-TYPE1 \
  --header 'X-Auth-Token: eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..y833ZmRAlU6xMF8BeHLLhCHL5Yr45LfoW4QoEyaRHgA'

**Update container type by key**
	...
	"attributeDefinitions": [
		{
			...
			"metaType": "String",
			"name": "ct-ad-11",
			"displayName": "cont-type-attrib-def-11",
			"isCollection": true,
			"isModifiable": true,
			"isMandatory": false,
			"defaultValue": {
...
**Get container type attribute definition by id**

curl --request GET \
  --url http://localhost:9000/types/container/CONT-TYPE1/attribdefs/1 \
